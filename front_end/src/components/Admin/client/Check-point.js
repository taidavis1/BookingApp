...
export default function CheckPoint(props) {
    ...
    return (
        <div className="flex flex-col px-5 py-4 space-y-6 bg-gray-100 min-h-screen">
            <div className="text-start justify-start ml-6">
                <span className="text-blue text-5xl" style={{fontFamily : 'Tangerine'}}>This is checking point page</span>
            </div>
